	...
	<div id="Form1" class="wrap">
        <div id="wrap" class="frm">
			...
			<div class="btn-group btn-group-justified" role="group" style="margin-bottom:15px;">
				...
				<div class="btn-group" role="group">
					<a class="btn btn-default" href='<c:url value="/devNotes.do"/>' target="demoFrame" > 개발노트</a>
				</div>
			</div>
							...
							<div class="btn_bottom_right">
								...
								<c:choose>
									<c:when test="${sessionScope.memberId != null }">
										${sessionScope.memberName} 님 반갑습니다. 
                	...
                	<td style="vertical-align: top;width:250px;">
						<div class="panel-group" id="accordion">
								...
								<div id="collapse1" class="panel-collapse collapse in">
									<div class="panel-body">
										<div class="examples list-group">
											...
											<a href='<c:url value="/board/gList.do"/>' class="list-group-item" target="demoFrame">
												자유게시판(그리드)
											</a>
											<c:if test="${ sessionScope.memberId != null }">
											<a href='<c:url value="/message/goMessagePage.do"/>' class="list-group-item" target="demoFrame">
												메시지
											</a>
											</c:if>
										</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse3">회원 관리</a>
									</h4>
								</div>
								<div id="collapse3" class="panel-collapse collapse">
									<div class="panel-body">
										<div class="examples list-group">
											<a href='<c:url value="/mList.do"/>' class="list-group-item" target="demoFrame">
												회원 목록
											</a>
										</div>
									</div>
