					...
					<form method="get">
						<fieldset>
							...
							<div class="paginate">
								...
								<a class="pre" href="<c:url value='/board/list.do?currentPage=${pageBlockStart-1}&searchType=${searchType}&searchText=${searchText}' />">이전페이지</a>
								</c:if>
								<c:forEach begin="${ pageBlockStart }" end="${ pageBlockEnd }" step="1" var="pageNo">
									<c:choose>
										...
										<c:otherwise>											
											<a href="<c:url value='/board/list.do?currentPage=${pageNo}&searchType=${searchType}&searchText=${searchText}' />">
												${ pageNo }</a>
										</c:otherwise>
									</c:choose>
								</c:forEach>
							...
							<div class="btn_bottom">
								<div class="btn_bottom_right">
									<a href="<c:url value='/board/goWritePage.do?gridValue=0'/>">
