...
public class BoardDaoImpl implements BoardDao{
	...
	public List<Map<String,Object>> selectList(HashMap<String, String> params) {
		String sql = "SELECT * FROM board WHERE type_seq = 2 ";
		String selectType = params.get("selectType") == null ? "" : params.get("selectType");
		...
		sql += " ORDER BY `board_seq` DESC LIMIT ?, ?"; //board의 모든 column을 조회
		Object[] args = null;
		...
		} else if(selectType.equals("2") || selectType.equals("3")) {
			args = new Object[] {
	...
	public int getTotalCount(HashMap<String, String> params) {
		...
		Object[] args = null;
		if(selectType.equals("2") || selectType.equals("3")) {
			args = new Object[] {
					params.get("searchText")
			};
		} else if(selectType.equals("1")) {
